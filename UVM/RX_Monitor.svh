 class RX_Monitor extends uvm_monitor;
    ...
    function void build_phase(uvm_phase phase);
        ...
        if(!uvm_config_db#(virtual RX_IF)::get(this,"","RXvif",RXvif))
            uvm_report_error("Monitor","Can't get RX_IF from the config db",UVM_LOW);
    ...
    task run_phase(uvm_phase phase);
        ...
        forever begin
            ...
            collect_transaction(rx_item);
            analysis_port.write(rx_item);
			$display("Transaction Written Successfully to Scoreboard and Subscriber");
			void'(rx_item.print_tr("RX_Monitor"));
        end
    endtask
    
    task collect_transaction(RX_Transaction rx_item);
